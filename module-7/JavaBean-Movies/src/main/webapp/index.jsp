<%--
    ...
    Date: 9/19/2026
    Module: 7.2
    Assignment: Movie Database Project Part 2
    Description: Main page containing links to view the movie database
    and add a new movie record.
--%>
...
<div class="container">
    ...
    <p>
        ...
        information. Users can view existing movie records or add a new
