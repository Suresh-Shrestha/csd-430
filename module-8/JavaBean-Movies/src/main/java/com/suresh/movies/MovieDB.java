...
public class MovieDB {
    ...
    // Updates an existing movie record using the movie ID.
    public static boolean updateMovie(MovieBean movie) {

        String sql =
                "UPDATE sureshmoviesdata " +
                        "SET title = ?, genre = ?, release_year = ?, director = ? " +
                        "WHERE movie_id = ?";
